...
Different computers will run this code at different speeds (even measured in “cycles per second”). In order to have a level playing field, everyone must use the 2400 machines on the https://coding.csel.io platform to time their projects. 
